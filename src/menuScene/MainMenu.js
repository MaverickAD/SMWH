...
export default class MainMenu extends Phaser.Scene {
    ...
    preload(){
        this.load.image('homemenu1', 'https://raw.githubusercontent.com/MaverickAD/SMWH/main/assets/homemenu1.jpg');
        this.load.image('homemenu2', 'https://raw.githubusercontent.com/MaverickAD/SMWH/main/assets/homemenu2.jpg');
        this.load.image('homemenu3', 'https://raw.githubusercontent.com/MaverickAD/SMWH/main/assets/homemenu3.jpg');
        this.load.image('homemenu4', 'https://raw.githubusercontent.com/MaverickAD/SMWH/main/assets/homemenu4.jpg');
    }
    ...
    create() {
        ...
        this.playButton     = this.add.rectangle(width / 2, height / 8, 200, 100, 0x0000FF, 1)
        this.playText       = this.add.text(this.playButton.x, this.playButton.y, "Play", {color: '#000000'}).setOrigin(0.5)

        this.settingsButton = this.add.rectangle(width / 3, 6 * height / 7, 200, 100, 0xFFFFFF, 1)
        this.settingsText   = this.add.text(this.settingsButton.x, this.settingsButton.y, "Settings", {color: '#000000'}).setOrigin(0.5)

        this.creditButton   = this.add.rectangle(2 * width / 3, 6 * height / 7, 200, 100, 0xFFFFFF, 1)
    ...
    update() {
        ...
        if (this.inputKeysMeta.UP.isDown && this.inputKeysMeta.UP.timeDown - this.lastShiftDownTime > 100){
        ...
        if (this.inputKeysMeta.DOWN.isDown && this.inputKeysMeta.DOWN.timeDown - this.lastShiftDownTime > 100){
