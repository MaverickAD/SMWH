...
export default class DialogLevel1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.dialogFirst.setText(this.lorem, true)
    }

    update() {
        if(this.inputKeys.SPACE.isDown && !this.firstDialogDone){
            this.firstDialogDone = true
            this.dialogFirst.shutdown()
            this.dialogFirst.setText(this.lorem, false)
        }
    }
}